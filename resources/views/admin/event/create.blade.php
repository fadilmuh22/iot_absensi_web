...
<div class="container-fluid">
    <form action="{{ url('admin/event/store') }}" method="post">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12">
                    <input required type="text" name="nama" class="form-control" placeholder="Nama Event"
                        value="{{ old('nama') }}">
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <input required type="text" name="tempat" class="form-control"
                        placeholder="Tempat Event Berlangsung" value="{{ old('tempat') }}">
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class='input-group date'>
                        <input required id='tanggalDateTime' type='text' name="tanggal" class="form-control"
                            placeholder="Tanggal Event Berlangsung" value="{{ old('tanggal') }}" />
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12">
                    <input required type="number" name="durasi" class="form-control"
                        placeholder="Durasi Event (Dalam Jam)" value="{{ old('durasi') }}">
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
